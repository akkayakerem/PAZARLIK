...
const mockProducts: Product[] = [
  ...
  {
    id: '5',
    name: 'İkinci El Adidas Spor Ayakkabı',
    brand: 'Spor',
    price: '₺380.00',
  ...
  {
    id: '6',
    name: 'Kullanılmış Samsung Galaxy S21',
    brand: 'Elektronik',
    price: '₺6.500.00',
...
const categories = ['TÜMÜ', 'ELEKTRONİK', 'GİYİM', 'EV EŞYASI', 'SPOR', 'AKSESUAR'];
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={styles.header}>
          ...
          <View style={styles.headerCenter}>
            <Text style={styles.headerTitle}>ALIŞVERİŞ</Text>
